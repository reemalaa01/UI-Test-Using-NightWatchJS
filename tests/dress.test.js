...
describe('Search Module', function() {
  ...
  it.skip('Should search for "dress" and show it in results', async function(browser) {
...
/*Test 3: Verify sort by lowest price
  ...
  it.skip('Should sort products by lowest price first', async function(browser) {
  ...
  it.skip('Should sort products by highest price first', async function(browser) {
