...
const reporter = new HtmlReporter({
  openBrowser: true,                               // auto-open after test
  reportsDirectory: __dirname + '/reports/html',   // folder for reports
  themeName: 'default'                             // "default", "compact", "bootstrap"
});
module.exports = {
...
//  reporters: [
//   'junit',          // XML format
//   'html-reporter'   // HTML format
// ],

// reporter: (results, done) => {
//   const HtmlReporter = require('nightwatch-html-reporter');
//   const reporter = new HtmlReporter({
//     openBrowser: true,                // auto-open report in browser
//     reportsDirectory: __dirname + '/reports', // folder for reports
//     themeName: 'default'              // or 'compact', 'default', 'bootstrap'
//   });
//   reporter.fn(results, done);
// },
      webdriver: {
